...
Separate chunk for correlation metrics as well
...
for (i in 1:84){
  #pull out one subject (remove dependant variable)
...
* diagnosis flag
* 80 sensore values (5 values for each of 16 sensors)
